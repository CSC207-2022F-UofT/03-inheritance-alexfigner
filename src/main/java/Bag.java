...
public abstract class Bag {
    ...
    public void setColor(String bagColour){
        this.color = bagColour;
    }
    ...
    public boolean addItem(String bagItem){
        if (this.numberOfContents < this.capacity){
            int idx = this.numberOfContents;
            this.contents[idx] = bagItem;
    ...
    public String popItem(){
        if (this.numberOfContents == 0){
            ...
            int idx = this.numberOfContents - 1;
            String toReturn = this.contents[idx];
